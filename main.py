    ...
    if uploaded_file is not None:
        ...
        if st.button("Calculer les calories 🚀", use_container_width=True):
            with st.spinner("Analyse par l'IA..."):
                try:
                    prompt = "Analyse l'image en tant expert en nutition. Réponds UNIQUEMENT en JSON : {'plat': 'nom', 'calories': 0, 'proteines': 0, 'glucides': 0, 'lipides': 0, 'note_perte': 0, 'note_prise': 0}"
